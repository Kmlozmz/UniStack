    ...
    private fun profileMap(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "accessibilityPreferences" to mapOf(
                ...
                "dateFormat" to profile.accessibilityPreferences.dateFormat.name,
                "currency" to profile.accessibilityPreferences.currency.name,
                "contrast" to profile.accessibilityPreferences.contrast.name,
                "colorBlindPalette" to profile.accessibilityPreferences.colorBlindPalette.name,
                "shapesBesidesColor" to profile.accessibilityPreferences.shapesBesidesColor,
                "boldText" to profile.accessibilityPreferences.boldText,
                "readingFont" to profile.accessibilityPreferences.readingFont.name,
                "touchTargetSize" to profile.accessibilityPreferences.touchTargetSize.name,
                "reduceTransparency" to profile.accessibilityPreferences.reduceTransparency,
                "oneHandedMode" to profile.accessibilityPreferences.oneHandedMode,
                "undoDuration" to profile.accessibilityPreferences.undoDuration.name,
                "spokenDescriptions" to profile.accessibilityPreferences.spokenDescriptions,
                "confirmIrreversible" to profile.accessibilityPreferences.confirmIrreversible,
                "keepScreenOn" to profile.accessibilityPreferences.keepScreenOn
            ),
            ...
            "termEndReminderEnabled" to profile.termEndReminderEnabled,
            "nextTermReminderEnabled" to profile.nextTermReminderEnabled,
            "nextTermReminderOffset" to profile.nextTermReminderOffset,
