# Cambios anteriores al reinicio de versiones

Este archivo es el histórico. Va fuera del APK y la app no lo lee: en Novedades solo sale la
versión que tienes puesta.

Se guarda porque las veinte entradas de aquí abajo son el registro de cómo llegó la app hasta
la primera versión estable. El lanzamiento oficial reiniciará la numeración en 1.0, así que
estos números —de la 1.0.x a la 1.4.3— no volverán a aparecer.
